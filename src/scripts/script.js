...
const footerPaginationNode = document.querySelector(".footer__left-block");
footerPaginationNode.innerHTML=`
                                <p class="page">First<p>
                                <p class="page">1<p>
                                <p class="page">2<p>
                                <p class="page">3<p>
                                <p class="page">4<p>
                                ...
                                <p class="page">Last<p>
`
console.log(footerPaginationNode);
